...
if("TRUE" STREQUAL "TRUE")
  set(novatel_msgs_SOURCE_PREFIX /home/liu/dbw_ws/src/novatel_span_driver/novatel_msgs)
  set(novatel_msgs_DEVEL_PREFIX /home/liu/dbw_ws/devel)
  ...
  set(novatel_msgs_INSTALL_PREFIX /home/liu/dbw_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'novatel_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'novatel_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/liu/dbw_ws/src/novatel_span_driver/novatel_msgs/${idir}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
    endif()
