...
void callback_lidar_sync(const sensor_msgs::PointCloud2ConstPtr& cloud_msg_1, 
    ...
    // fprintf(f_1, "%f,", imu_report->header.stamp.toSec());
    // fprintf(f_1, "%f,", imu_report->angular_velocity.z);
    // fprintf(f_1, "%f,", steering_report->header.stamp.toSec());
    // fprintf(f_1, "%f\n", steering_report->speed);
    ...
    pcl::toROSMsg(cloud_fuse_wo_speed,cloud_fuse_msg_wo_speed);
