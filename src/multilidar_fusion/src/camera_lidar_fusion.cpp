...
void c_l_fusion(const sensor_msgs::PointCloud2ConstPtr& cloud_msg, 
    ...
    // std::cout << rgb_projected_cloud.size().width << " " << rgb_projected_cloud.size().height << " " << rgb_projected_cloud.channels() << "\n";
    ...
    // std::cout << img.size().width << " " << img.size().height << " " << img.channels() << "\n";
